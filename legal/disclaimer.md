...
- The AI agent **can and does lose simulated money.** It has no special knowledge of the future.
- **No AI can guarantee gains.** Anyone claiming otherwise — here or anywhere — is wrong.

## About historical statistics

Where we show measured historical figures — for example, how a stock behaved in the month after similar past price moves — those describe **what already happened**, computed from historical prices. They are not forecasts, and the sample sizes are often small. **Past performance does not predict future results.**
...
Simulated margin lets you borrow virtual money to buy more than your virtual cash allows.

Leverage **amplifies losses exactly as much as it amplifies gains**, and you still owe the loan regardless of which way the trade went. If your equity falls below the maintenance requirement, positions are **sold automatically**, often at the worst possible moment. Interest accrues daily.

This is included precisely so you can experience a margin call somewhere it costs you nothing. Please take the lesson seriously — in real markets, this is where inexperienced traders are most often wiped out.

## Simulated results are not real results

Even a perfect simulation cannot reproduce real trading. In real markets you also face slippage, partial fills, liquidity constraints, fees, taxes, spreads, halts, and — hardest of all — your own emotions with real money on the line. **Doing well here does not mean you would do well with real money.**

## Market data

Prices, charts, company data, and news come from third-party providers and may be delayed, interrupted, incomplete, or inaccurate. We do not independently verify them.
